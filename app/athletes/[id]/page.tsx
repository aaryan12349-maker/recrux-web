  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(to_bottom,#f5f5f4,#fafaf9)] p-6">
      <div className="mx-auto max-w-6xl">
        ...
        <a
          href="/dashboard"
          className="mb-6 inline-block rounded-full border border-neutral-300 bg-white px-5 py-2 text-sm font-semibold text-neutral-900"
        >
          Back to Dashboard
        </a>
          ...
          <div className="grid gap-8 lg:grid-cols-[340px_1fr]">
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <button className="rounded-full border border-neutral-300 bg-white px-6 py-3 text-sm font-semibold text-neutral-900">
                  Request More Info
                </button>
              </div>
